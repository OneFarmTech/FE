...
const Support = () => (
  <main className="max-w-[1700px] m-auto">
    <section className="w-full max-w-[2000px] m-auto flex flex-col items-center gap-7 py-10 px-[4%]">
      ...
      <p>Whether you have questions, complaints, feedback, or partnership inquiries, our team is ready to assist you.</p>
    </section>
   ...
   <section className="py-7 px-[5%] w-full flex flex-col md:flex-row md:gap-10 md:items-center">
      ...
      <div className="flex-1">
        ...
        <form action="https://formspree.io/f/mqkrwpzk" method="POST" className="flex flex-col gap-6">
          ...
          <button type="submit" className=' bg-green-500 hover:bg-green-700 text-white font-bold py-4 px-4 rounded-[10px]  w-full'
   >      Send
         </button>
        </form>
      </div>
